...
class DriftEvaluator:
    ...
    def __init__(self, scores, drift_indices, n_chunks):
        self.__scores = []
    ...
    def calculate_recovery_lengths(self):
        ...
        for idx in self.__drift_indices:
            ...
            while self.__scores[score_idx] < 0.95*self.__median_scores[median_score_idx]:
                score_idx += 1
            recovery_lengths.append((score_idx-idx)/self.n_chunks) # divided by number of chunks
            median_score_idx += 1
    ...
    def calculate_performance_loss(self):
        ...
        for idx in self.__drift_indices:
            ...
            loss = (min_stream_score - min_score) / max(min_stream_score, 0.0000001)
